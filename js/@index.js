...
require("tfw.hash-watcher",function(n,t,r){var o=function(){function t(){return o(r,arguments)}var r={en:{}},o=n("$").intl;return t.all=r,t}(),e=n("tfw.listeners"),a="?random-hash."+Date.now(),i=0,s="",u=[],c=new e;t.exports=function(n){c.add(n),i||(i=window.setInterval(function(){var n=window.location.hash;if(a!=n){for(a=n,"#"==n.charAt(0)&&(n=n.substr(1)),s=n;"/"==n.charAt(0);)n=n.substr(1);u=n.split("/").map(function(n){return decodeURI(n)}),c.fire(u,window.location.hash)}},50))},t.exports.args=function(){return u},t.exports.hash=function(){return s},t.exports._=o});
...
require("wallet",function(r,e,t){function n(){var r=u.get("wallet",JSON.parse(f));return r&&Array.isArray(r.items)||(r=JSON.parse(f)),r.items}function o(r){void 0===r?r=[]:Array.isArray(r)||(r=[]);var e=u.get("wallet",JSON.parse(f));e&&Array.isArray(e.items)||(e=JSON.parse(f)),"number"==typeof e.version?e.version++:e.version=0,e.items=r,u.set("wallet",e)}function i(r){return r=r.toLowerCase(),function(e){return e.name.toLowerCase()==r}}function a(r){return r=r.toLowerCase(),function(e){return e.name.toLowerCase()!=r}}var s=function(){function e(){return n(t,arguments)}var t={en:{},fr:{}},n=r("$").intl;return e.all=t,e}(),u=r("tfw.storage").local;e.exports={set:function(r,t,i){var a=n();e.exports.del(r),a.push({name:r,usr:t,pwd:i}),o(a)},del:function(r){o(n().filter(a(r)))},get:function(r){return n().find(i(r))},clear:function(){o()},list:function(){var r=n(),e=r.slice();return e.sort(function(r,e){return r=r.name.toLowerCase(),e=e.name.toLowerCase(),r<e?-1:r>e?1:0}),e},tree:function(){e.exports.list().map(function(r){return{key:r,val:r.split("/").map(function(r){return r.toLowerCase()})}})}};var f=JSON.stringify({version:0,items:[]});e.exports._=s});
...
require("offline",function(r,e,o){var n=function(){function e(){return n(o,arguments)}var o={en:{},fr:{}},n=r("$").intl;return e.all=o,e}();navigator.serviceWorker&&(navigator.serviceWorker.register("offline.js",{scope:"/pwd-wallet/"}),navigator.serviceWorker.ready.then(function(r){console.info("Service Worker is ready for ",r.scope)}).catch(function(r){console.error("Registration failed with: ",r)})),e.exports._=n});
